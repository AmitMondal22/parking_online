  ...
  const add_header_footer = async (req, res) => {
    try {
      ...
      let fields =
        ...
        values = `('${value.cust_id}','${value.header_1}','${
        ...
        }','${value.footer_4}','${value.footer_4_flag == 1 ? 1 : 0}','${datetime}')`;
...
module.exports = {customer,show_header_footer,edit_header_footer,add_header_footer,edit_save_header_footer }